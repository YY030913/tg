# Contributing to TalkGet

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to TalkGet and its packages, which are hosted in the [TalkGet Organization](https://github.com/TAGT) on GitHub.
