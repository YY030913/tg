describe 'Spotify integration', () ->
	describe 'Spotify id transformer', () ->
		it 'should transform track id to link and add it to message urls', () ->
			...
			output = TAGT.Spotify.transform message
	...
	describe 'Spotify id autolinker', () ->
		it 'should autolink spotify id', () ->
			message = TAGT.Spotify.transform {'urls': [], 'msg': 'spotify:track:34AWo71Ya5gq7wpNnatwr7', 'html': 'spotify:track:34AWo71Ya5gq7wpNnatwr7'}
			output = TAGT.Spotify.render message
		...
		it 'should autolink spotify id even if wrapped around text', () ->
			message = TAGT.Spotify.transform {'urls': [], 'msg': 'a text before spotify:track:34AWo71Ya5gq7wpNnatwr7 a text after', 'html': 'a text before spotify:track:34AWo71Ya5gq7wpNnatwr7 a text after'}
			output = TAGT.Spotify.render message
