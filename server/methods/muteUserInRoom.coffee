Meteor.methods
	muteUserInRoom: (data) ->
		...
		mutedUser = TAGT.models.Users.findOneByUsername data.username

		TAGT.models.Rooms.muteUsernameByRoomId data.rid, mutedUser.username

		fromUser = TAGT.models.Users.findOneById fromId
		TAGT.models.Messages.createUserMutedWithRoomIdAndUser data.rid, mutedUser,
			u:
				_id: fromUser._id
