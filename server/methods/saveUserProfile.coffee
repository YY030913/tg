Meteor.methods
	saveUserProfile: (settings) ->
		...
		unless TAGT.settings.get("Accounts_AllowUserProfileChange")
		...
		user = TAGT.models.Users.findOneById Meteor.userId()
		...
		TAGT.models.Users.setProfile Meteor.userId(), profile
