TAGT.Migrations.add({
	...
	up: function() {
		if (TAGT && TAGT.models && TAGT.models.Settings) {
			var footer = TAGT.models.Settings.findOne({ _id: 'Layout_Sidenav_Footer' });
			...
			if (footer && footer.value !== '') {
				...
				TAGT.models.Settings.update({ _id: 'Layout_Sidenav_Footer' }, { $set: { value: footerValue, packageValue: footerValue } });
			}
		}
	}
});
