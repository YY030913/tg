...
const pkgdef :Spk.PackageDefinition = (
	...
	manifest = (
		...
		metadata = (
			icons = (
				appGrid = (svg = embed "talk.get-128.svg"),
				grain = (svg = embed "talk.get-24.svg"),
				market = (svg = embed "talk.get-150.svg"),
			),

			website = "https://caoliao.net.cn",
			codeUrl = "https://github.com/TAGT/TalkGet",
			license = (openSource = mit),
			categories = [communications, productivity, office, social, developerTools],

			author = (
				contactEmail = "team@talk.get",
				pgpSignature = embed "pgp-signature",
				upstreamAuthor = "TalkGet",
			),
