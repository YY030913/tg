...
- Add package tagt-custom-emoji
- Add package tagt-emoji-base: a base package for adding new sets of emoji
...
- Add snap package yaml for TalkGet
...
- Moved createPrivateGroup to tagt-lib
...
- Adding TalkGet templates to deploy on OpenShift
...
- Add correct tagt-ui-message files
...
- Add /shrug command
- Add /topic
- Add back the role bot to talk get - closes #3098
...
- Internal Hubot naming clarification tagt:hubot -> tagt:internal-hubot RocketBot -> InternalHubot RocketBot_Name -> InternalHubot_Username
...
- Replace arunoda:streams by tagt:streamer (#2842)
- Set pin-message permissions only on insert
- Several UI improvements
- Simplify and fix ADMIN_EMAIL verification regex. Fixes TAGT/TalkGet#2841 (#2890)
...
- Close #2696 TAGT hijacking Firefox shortcut
...
- Use TAGT Logger as SyncedCron logger
...
- Expose Assets methods via TAGT.Assets
...
- Expose emoji picker in TAGT namespace
...
- Improved sidebar overlay - should fix TAGT/TalkGet.Cordova#15
...
- Switched CAS configuration from Meteor.settings to TAGT.settings.
...
- Add i18n to tagt-ui-flextab package, with default strings for file deletion dialogue
...
- Fix trying to read build from TAGT.Info when it is not available.
...
- Use the TAGT.Info.version on headers
...
- Closes #2078; ObserveChanges on tagt_room Not Using Oplog
...
- Detect if system is runing GM or IM, add info to TAGT.Info and …
...
- Allow arrays of keys in TAGT.settings.onload
...
- Create a user talk get and set avatar on system initialization
- Departments support
