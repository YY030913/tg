Meteor.methods
	unreadMessages: (firstUnreadMessage) ->
		...
		originalMessage = TAGT.models.Messages.findOneById firstUnreadMessage._id, {fields: {u: 1, rid: 1, file: 1, ts: 1}}
		...
		lastSeen = TAGT.models.Subscriptions.findOneByRoomIdAndUserId(originalMessage.rid, Meteor.userId()).ls
		...
		TAGT.models.Subscriptions.setAsUnreadByRoomIdAndUserId(originalMessage.rid, Meteor.userId(), originalMessage.ts)
