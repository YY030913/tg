Template.livechatAppearance.helpers({
	...
	emailOffline() {
		return TAGT.settings.get('Livechat_offline_email');
	},
	sampleColor() {
...
Template.livechatAppearance.onCreated(function() {
	...
	this.autorun(() => {
		this.title.set(TAGT.settings.get('Livechat_title'));
	});
	this.autorun(() => {
		this.color.set(TAGT.settings.get('Livechat_title_color'));
	});
	this.autorun(() => {
		this.displayOfflineForm.set(TAGT.settings.get('Livechat_display_offline_form'));
	});
	this.autorun(() => {
		this.offlineUnavailableMessage.set(TAGT.settings.get('Livechat_offline_form_unavailable'));
	});
	this.autorun(() => {
		this.offlineMessage.set(TAGT.settings.get('Livechat_offline_message'));
	});
	this.autorun(() => {
		this.offlineSuccessMessage.set(TAGT.settings.get('Livechat_offline_success_message'));
	});
	this.autorun(() => {
		this.titleOffline.set(TAGT.settings.get('Livechat_offline_title'));
	});
	this.autorun(() => {
		this.colorOffline.set(TAGT.settings.get('Livechat_offline_title_color'));
	});
});
...
Template.livechatAppearance.events({
	...
	'click .reset-settings'(e, instance) {
		...
		instance.title.set(TAGT.settings.get('Livechat_title'));
		instance.color.set(TAGT.settings.get('Livechat_title_color'));
		instance.displayOfflineForm.set(TAGT.settings.get('Livechat_display_offline_form'));
		instance.offlineUnavailableMessage.set(TAGT.settings.get('Livechat_offline_form_unavailable'));
		instance.offlineMessage.set(TAGT.settings.get('Livechat_offline_message'));
		instance.offlineSuccessMessage.set(TAGT.settings.get('Livechat_offline_success_message'));
		instance.titleOffline.set(TAGT.settings.get('Livechat_offline_title'));
		instance.colorOffline.set(TAGT.settings.get('Livechat_offline_title_color'));
	...
	'submit .rocket-form'(e, instance) {
		...
		TAGT.settings.batchSet(settings, (err/*, success*/) => {
			if (err) {
