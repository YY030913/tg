Meteor.methods({
	'livechat:removeAgent'(username) {
		...
		if (TAGT.authz.removeUserFromRoles(user._id, 'livechat-agent')) {
			TAGT.models.Users.setOperator(user._id, false);
			TAGT.models.Users.setLivechatStatus(user._id, 'not-available');
			return true;
		}
