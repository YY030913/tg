 ...
 */
TAGT.models.Users.setOperator = function(_id, operator) {
	var update = {
		$set: {
			operator: operator
		}
 ...
 * @return
 */
TAGT.models.Users.findOnlineAgents = function() {
	var query = {
 ...
 * @return
 */
TAGT.models.Users.findAgents = function() {
	var query = {
		roles: 'livechat-agent'
	};
 ...
 * @return
 */
TAGT.models.Users.findOnlineUserFromList = function(userList) {
	var query = {
		statusConnection: { $ne: 'offline' },
		statusLivechat: 'available',
		roles: 'livechat-agent',
 ...
 */
TAGT.models.Users.getNextAgent = function() {
	var query = {
		statusConnection: { $ne: 'offline' },
		statusLivechat: 'available',
		roles: 'livechat-agent'
 ...
 */
TAGT.models.Users.getVisitorByToken = function(token, options) {
	var query = {
		'profile.guest': true,
		'profile.token': token
	};
 ...
 * @param {string} token - Visitor token
 */
TAGT.models.Users.findVisitorByToken = function(token) {
	var query = {
		'profile.guest': true,
		'profile.token': token
	};
 ...
 * @param {string} token - Visitor token
 */
TAGT.models.Users.setLivechatStatus = function(userId, status) {
	let query = {
		'_id': userId
	};
 ...
 */
TAGT.models.Users.closeOffice = function() {
	self = this;
 ...
 */
TAGT.models.Users.openOffice = function() {
	self = this;
	self.findAgents().forEach(function(agent) {
...
TAGT.models.Users.updateLivechatDataByToken = function(token, key, value) {
	const query = {
		'profile.token': token
	};
 ...
 * @return {object} User from db
 */
TAGT.models.Users.findOneVisitorByPhone = function(phone) {
	const query = {
 ...
 */
TAGT.models.Users.getNextVisitorUsername = function() {
