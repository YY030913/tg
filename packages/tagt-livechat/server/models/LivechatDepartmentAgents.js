 ...
 */
class LivechatDepartmentAgents extends TAGT.models._Base {
	constructor() {
		super();
	...
	getNextAgentForDepartment(departmentId) {
		...
		var onlineUsers = TAGT.models.Users.findOnlineUserFromList(_.pluck(agents, 'username'));
...
TAGT.models.LivechatDepartmentAgents = new LivechatDepartmentAgents();
