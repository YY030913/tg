(function(factory) {
    ...
    _e(function(E, $) {
        ...
        Txt.fn.initHeight = function() {
            ...
            valueContainerHeight = document.body.scrollHeight;
            var menuHeight = editor.menuContainer.height();
            var txtHeight = valueContainerHeight - menuHeight - $(".debate-name").outerHeight() - $(".fixed-title").outerHeight() - 20;

            // 限制最小为 50px
            txtHeight = txtHeight < 50 ? 50 : txtHeight;

            // $txt.height(txtHeight);
            $txt.css("height", txtHeight + "px");
    ...
    _e(function(E, $) {
        ...
        E.createMenu(function(check) {
            ...
            $btnSubmit.click(function(e) {
                ...
                var $link;
                var width = parseInt(document.body.scrollWidth /*$widthInput.val()*/ );
                var height = parseInt(498 /*$heightInput.val()*/ );
                var $div = $('<div>');
    ...
    _e(function(E, $) {
        ...
        E.plugin(function() {
            ...
            if (!customUpload) {
                ...
                console.log('自定义上传无效，详看浏览器日志console.log');
