...
Meteor.startup(function() {
	TAGT.settings.addGroup('CAS', function() {
...
function updateServices(/*record*/) {
	...
	timer = Meteor.setTimeout(function() {
		var data = {
			...
			enabled:          TAGT.settings.get('CAS_enabled'),
			base_url:         TAGT.settings.get('CAS_base_url'),
			login_url:        TAGT.settings.get('CAS_login_url'),
			// Rocketchat Visuals
			buttonLabelText:  TAGT.settings.get('CAS_button_label_text'),
			buttonLabelColor: TAGT.settings.get('CAS_button_label_color'),
			buttonColor:      TAGT.settings.get('CAS_button_color'),
			width:            TAGT.settings.get('CAS_popup_width'),
			height:           TAGT.settings.get('CAS_popup_height'),
			autoclose:        TAGT.settings.get('CAS_autoclose')
		};
