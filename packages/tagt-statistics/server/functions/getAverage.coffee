TAGT.statistics.getAverage = ->
	...
	result = TAGT.models.Statistics.model.mapReduce(m, r, { finalize: f, out: "tagt_mr_statistics" })
	statistics = TAGT.models.MRStatistics.find().fetch()
	return statistics
