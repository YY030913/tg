TAGT.Notifications = new class
	constructor: ->
		...
		if @debug is true
			@onAll -> console.log "TAGT.Notifications: onAll", arguments
			@onUser -> console.log "TAGT.Notifications: onAll", arguments


	notifyRoom: (room, eventName, args...) ->
		console.log "TAGT.Notifications: notifyRoom", arguments if @debug is true

		args.unshift "#{room}/#{eventName}"
		@streamRoom.emit.apply @streamRoom, args

	notifyUser: (userId, eventName, args...) ->
		console.log "TAGT.Notifications: notifyUser", arguments if @debug is true

		args.unshift "#{userId}/#{eventName}"
		@streamUser.emit.apply @streamUser, args

	notifyUsersOfRoom: (room, eventName, args...) ->
		console.log "TAGT.Notifications: notifyUsersOfRoom", arguments if @debug is true
	...
	onRoom: (room, eventName, callback) ->
		if @debug is true
			@streamRoom.on room, -> console.log "TAGT.Notifications: onRoom #{room}", arguments
