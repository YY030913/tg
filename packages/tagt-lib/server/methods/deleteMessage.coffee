Meteor.methods
	deleteMessage: (message) ->
		...
		originalMessage = TAGT.models.Messages.findOneById message._id, {fields: {u: 1, rid: 1, file: 1}}
		...
		hasPermission = TAGT.authz.hasPermission(Meteor.userId(), 'delete-message', originalMessage.rid)
		deleteAllowed = TAGT.settings.get 'Message_AllowDeleting'
		...
		TAGT.deleteMessage(originalMessage, Meteor.user());
