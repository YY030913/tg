...
TAGT.settings.add('uniqueID', process.env.DEPLOYMENT_ID or Random.id(), { public: true, hidden: true });

# When you define a setting and want to add a description, you don't need to automatically define the i18nDescription
# if you add a node to the i18n.json with the same setting name but with `_Description` it will automatically work.
TAGT.settings.addGroup 'Accounts', ->
...
TAGT.settings.addGroup 'OAuth', ->
	...
	@section 'Google', ->
		...
		@add 'Accounts_OAuth_Google', true, { type: 'boolean', public: true }
		@add 'Accounts_OAuth_Google_id', '282710845697-rlerblta4drj4qqt7ugsq0jsg0h29j0g.apps.googleusercontent.com', { type: 'string', enableQuery: enableQuery }
		@add 'Accounts_OAuth_Google_secret', 'e33jvY_F9tZZc6-AhQhC25tW', { type: 'string', enableQuery: enableQuery }
...
TAGT.settings.addGroup 'Message', ->
...
TAGT.settings.addGroup 'Layout', ->

	@section 'Content', ->
		@add 'Layout_Home_Title', 'Home', { type: 'string', public: true }
		@add 'Layout_Home_Body', 'Welcome to TalkGet <br> Go to APP SETTINGS -> Layout to customize this intro.', { type: 'code', code: 'text/html', multiline: true, public: true }
...
# Meteor.startup ->
# 	TAGT.models.Settings.update({ ts: { $lt: TAGT.settings.ts }, persistent: { $ne: true } }, { $set: { hidden: true } }, { multi: true })
