...
TAGT.placeholders.replace = function(str, data) {
	if (!str) {
		return '';
	}

	str = str.replace(/\[Site_Name\]/g, TAGT.settings.get('Site_Name') || '');
	str = str.replace(/\[Site_URL\]/g, TAGT.settings.get('Site_Url') || '');
