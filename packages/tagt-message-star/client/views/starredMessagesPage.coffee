Template.starredMessagesPage.helpers
	hasMessages: ->
...
Template.starredMessagesPage.onCreated ->
...
Template.starredMessagesPage.events
	'click .message-cog': (e, t) ->
		...
		actions = TAGT.MessageAction.getButtons message, 'starred'
