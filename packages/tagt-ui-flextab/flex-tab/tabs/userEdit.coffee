Template.userEdit.helpers
	canEditOrAdd: ->
		return (Template.instance().user and TAGT.authz.hasAtLeastOnePermission('edit-other-user-info')) or (not Template.instance().user and TAGT.authz.hasAtLeastOnePermission('create-user'))
	...
	role: ->
		return TAGT.models.Roles.find({}, { sort: { description: 1, _id: 1 } })
