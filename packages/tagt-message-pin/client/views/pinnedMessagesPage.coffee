Template.pinnedMessagesPage.helpers
	hasMessages: ->
...
Template.pinnedMessagesPage.onCreated ->
...
Template.pinnedMessagesPage.events
	'click .message-cog': (e, t) ->
		...
		actions = TAGT.MessageAction.getButtons message, 'pinned'
