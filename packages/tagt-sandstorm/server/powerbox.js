...
TAGT.Sandstorm.offerUiView = function() {};
...
if (process.env.SANDSTORM === '1') {
	...
	TAGT.Sandstorm.offerUiView = function(token, serializedDescriptor, sessionId) {
	...
	Meteor.methods({
		...
		sandstormOffer: function(token, serializedDescriptor) {
			TAGT.Sandstorm.offerUiView(token, serializedDescriptor,
