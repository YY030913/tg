Meteor.startup ->
	...
	TAGT.callbacks.add 'streamMessage', roomSettingsChangedCallback, TAGT.callbacks.priority.HIGH
	...
	TAGT.callbacks.add 'streamMessage', roomNameChangedCallback, TAGT.callbacks.priority.HIGH
